(defproject cljs-core-async "0.1.0-SNAPSHOT"
  ...
  :profiles {:dev {:dependencies [[midje "1.6.3"]]
             ...
             :uberjar {:source-paths ["src/clj" "src/main"]
                       :main cljs-core-async.main
                       :aot [cljs-core-async.main]
  ...
  :cljsbuild {:builds {:client {:source-paths ["src/cljs"]
                                :compiler {:output-to "resources/public/intro.js"
                                           ...
                                           :pretty-print true}}}}
  :repl-options {:init-ns cljs-core-async.server.server}
  :uberjar-name "cljs-core-async.jar"
